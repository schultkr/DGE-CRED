...
sPathWD = pwd();
%% Define sectors
casSectors = {'Rice, Agriculture, forestry and fishing'; 'Industry'; 'Services'};
inbsectors_p = length(casSectors);
%% Define subsectors
casSubSectors = {'Rice'; 'Agriculture, forestry and fishing excluding rice'; 'Industry'; 'Services'};
inbsubsectors_p = length(casSubSectors);
%% Define regions
casRegions = {'Vietnam without MRD'; 'MRD'};
