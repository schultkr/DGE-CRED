% Update Sheets with Data stored in Data sheet of respective data file.
...
for icorow = 1:inbrow
    for icocol = 1:inbcol
        try 
            casCellNames = [casCellNames {exlFile.Sheets.Item('Data').Range([GetExcelColumn(icocol) num2str(icorow)]).Name.Name}];
        catch
