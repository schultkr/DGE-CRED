...
icosubsheet = icosubsheet + 1;
casVariables = {'initial population', 'initial value added', 'import share', 'housing to population ratio',...
    'investmetns in residential building relative to GDP', 'subsector for adaptation measures in the housing sector',...
    'subsector for private adaptation measures in the housing sector'};
