function [fval_vec,strys,strexo] = FindK(x,strys,strexo,strpar)
    ...
    strys.NX = strpar.omegaNXT_p * strys.Y * exp(strexo.exo_NX);
    ...
    strys.G = ((strpar.tauN_p * strys.wagebill + strpar.tauK_p * strys.capitalbill + strpar.tauC_p * strys.C) - strys.rf * strys.BG);
