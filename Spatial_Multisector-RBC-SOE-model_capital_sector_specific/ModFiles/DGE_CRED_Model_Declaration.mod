...
@# for sec in 1:Sectors
    ...
    @# for reg in 1:Regions
        ...
        phiY_@{sec}_@{reg}_p $\frac{P_{k,n,0} \, Y_{k,n,0}}{P_{0} \, Y_{0}}$ (long_name = 'share of regional and sectoral output')
        phiN_@{sec}_@{reg}_p ${N_{k,n,0}}$ (long_name = 'share of regional and sectoral employment')
